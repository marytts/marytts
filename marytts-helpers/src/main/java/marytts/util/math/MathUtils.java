...
public class MathUtils {
    ...
    public static double standardDeviation(double[] data, double meanVal, int startIndex,
                                           int endIndex) {
    ...
    public static ComplexNumber subtractComplex(double xReal, double xImag, double yReal,
            double yImag) {
        return new ComplexNumber(xReal - yReal, xImag - yImag);
    }
    ...
    public static ComplexNumber multiplyComplex(double xReal, double xImag, double yReal,
            double yImag) {
    ...
    public static ComplexNumber divideComplex(ComplexNumber x, double yReal, double yImag) {
        ...
        return new ComplexNumber((x.real * yReal + x.imag * yImag) / denum,
                                 (x.imag * yReal - x.real * yImag) / denum);
    }
    ...
    public static ComplexNumber divideComplex(double yReal, double yImag, ComplexNumber x) {
        ...
        return new ComplexNumber((yReal * x.real + yImag * x.imag) / denum,
                                 (yImag * x.real - yReal * x.imag) / denum);
    }
    ...
    public static ComplexNumber divideComplex(double xReal, double xImag, double yReal, double yImag) {
        ...
        return new ComplexNumber((xReal * yReal + xImag * yImag) / denum,
                                 (xImag * yReal - xReal * yImag) / denum);
    }
    ...
    public static double[][] vectorProduct(double[] x, boolean isColumnVectorX, double[] y,
    ...
    public static ComplexNumber[] levinson(ComplexNumber[] r, ComplexNumber[] c) {
        ...
        alpha = MathUtils.addComplex(alpha, MathUtils.multiplyComplex(xk,
                                     MathUtils.complexConjugate(beta)));
        q = MathUtils.divideComplex((MathUtils.subtractComplex(c[1], gamma)),
                                    MathUtils.complexConjugate(alpha));
        ...
        gamma = MathUtils.addComplex(MathUtils.multiplyComplex(h[0], r[2]), MathUtils.multiplyComplex(h[1],
                                     r[1]));
        int M1 = M - 1;
        ...
        for (int N = 2; N <= M1; N++) {
            ...
            alpha = MathUtils.addComplex(alpha, MathUtils.multiplyComplex(xk,
                                         MathUtils.complexConjugate(beta)));
            q = MathUtils.divideComplex(MathUtils.subtractComplex(c[N], gamma),
                                        MathUtils.complexConjugate(alpha));
    ...
    public static double interpolatedSample(double xStart, double xVal, double xEnd, double yStart,
                                            double yEnd) {
    ...
    // val2
    public static int[] findAnd(double[] x, int comparator1, double val1, int comparator2,
                                double val2) {
        int[] indices = null;
    ...
    public static int linearMap(int x, int xStart, int xEnd, int yStart, int yEnd) {
        return (int) Math.floor(((double) x - xStart) / ((double) xEnd - xStart) *
                                (yEnd - yStart) + yStart + 0.5);
    }
    ...
    public static void adjustMeanStandardDeviation(double[] x, double newMean,
    ...
    public static double getGaussianPdfValue(double[] x, double[] meanVector,
    ...
    // Log domain version
    public static double getGaussianPdfValueLog(double[] x, double[] meanVector,
            double[] covarianceMatrix,
