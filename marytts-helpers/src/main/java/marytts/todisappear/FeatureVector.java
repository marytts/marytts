...
public class FeatureVector {
    ...
    public int getLength() {
        return byteValuedDiscreteFeatures.length + shortValuedDiscreteFeatures.length +
               continuousFeatures.length;
    }
    ...
    public final byte getByteFeature(int index) {
        if (index < 0 || index >= byteValuedDiscreteFeatures.length) {
            throw new IndexOutOfBoundsException(index + " is not between 0 and " +
                                                byteValuedDiscreteFeatures.length);
        }
    ...
    public final float getContinuousFeature(int index) {
        return continuousFeatures[index - byteValuedDiscreteFeatures.length -
                                  shortValuedDiscreteFeatures.length];
    }
