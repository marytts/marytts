...
public class AudioConverterGUI extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .add(jPanel1Layout.createSequentialGroup()
                .add(jPanel1Layout.createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING)
                    ...
                    .add(cbPowerNormalise, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, 438, Short.MAX_VALUE)
        ...
        layout.setHorizontalGroup(
            ...
            .add(layout.createSequentialGroup()
                .addContainerGap()
                .add(progressBar, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, 470, Short.MAX_VALUE)
                .addContainerGap())
            .add(layout.createSequentialGroup()
                .add(90, 90, 90)
                .add(bRun)
    ...
    private void runActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_runActionPerformed
        ...
        if (inDirPath.equals("")) {
            JOptionPane.showConfirmDialog(this, "Input directory not specified!", "Info missing", JOptionPane.OK_OPTION, JOptionPane.ERROR_MESSAGE);
            return;
        }
        String outDirPath = tfOutputDir.getText();
        if (outDirPath.equals("")) {
            JOptionPane.showConfirmDialog(this, "Output directory not specified!", "Info missing", JOptionPane.OK_OPTION, JOptionPane.ERROR_MESSAGE);
            return;
        }
        ...
        if (rbRight.isSelected()) whichChannel = AudioPlayer.RIGHT_ONLY;
        else if (rbBoth.isSelected()) whichChannel = AudioPlayer.STEREO;
    ...
    public class Converter extends Thread
    {
        ...
        public void run()
        {
            ...
            int numSteps = 1;
            int stepsComplete = 0;
            if (maximiseAmplitude) numSteps++;
            if (powerNormalise) numSteps++;
            int interProgress = 0;
            ...
            try {
                ...
                if (powerNormalise) {
                    ...
                    for (int i=0; i<sessions.size(); i++) {
                        ...
                        double avgEnergySession = computeAverageEnergy(wavFiles, session.getFirst(), session.getSecond(),
                                stepsComplete*stepProgress+session.getFirst()*stepProgress/wavFiles.length,
                                stepsComplete*stepProgress+session.getSecond()*stepProgress/wavFiles.length);
                ...
                if (maximiseAmplitude) {
                    ...
                    System.out.println("Maximum amplitude of "+globalMaxAmplitude
                            +(powerNormalise ? " (after normalisation)":"")
                            +" found in file "+wavFiles[globalMaxIndex].getName());
         ...
         * @throws Exception
         */
        @Deprecated // using volume scaling integrated with energy normalisation instead.
        private int bestShiftBits(File[] wavFiles, int targetBitsPerSample, int progressMax)
        throws Exception
        {
        ...
        private double computeAverageEnergy(File wavFile)
        throws UnsupportedAudioFileException, IOException
        {
            ...
            f0TrackerParams.ws = energyAnalyser.getFrameLengthTime();
            f0TrackerParams.ss = energyAnalyser.getFrameShiftTime();
            ...
            double[][] speechStretches = energyAnalyser.getSpeechStretchesUsingEnergyHistory(
                    energyBufferLength, speechStartLikelihood, speechEndLikelihood,
        ...
        private double getMaxAbsAmplitude(File wavFile)
        throws UnsupportedAudioFileException, IOException
        {
