...
public class HMMParameterExtractor extends VoiceImportComponent {
    ...
    public final String LOCALE = "HMMParameterExtractor.locale";
    ...
    //public final String CONFIGFILE = "HMMParameterExtractor.configFile";
    ...
    protected void setupHelp() {
        ...
        props2Help.put(LOCALE,"locale ex: english"); 
    ...
    public boolean compute() throws Exception {
        ...
        for (int i=0; i<bnl.getLength(); i++) {
            ...
            generateParameters(bnl.getName(i));
     ...
     * @throws IOException
     */
    public void generateParameters(String file) throws IOException, InterruptedException{
