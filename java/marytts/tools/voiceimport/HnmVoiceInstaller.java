 ...
 *
 */
public class HnmVoiceInstaller extends VoiceImportComponent{
    
    private DatabaseLayout db;
    private String name = "HnmVoiceInstaller";
            ...
            //print name and version info
             ...
             //now follow the module settings
              ...
              configOut.println("# Java classes to use for the various unit selection components\n"+
                      ...
                      voiceHeader+".concatenatorClass        = marytts.unitselection.concat.HnmUnitConcatenator\n"+
                      ...
                      voiceHeader+".cartReaderClass          = marytts.cart.io.MARYCartReader\n"+
              		  voiceHeader+".audioTimelineReaderClass = marytts.unitselection.data.HnmTimelineReader\n");
