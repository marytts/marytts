...
public class GmmDiscretizer implements Discretizer {
     ...
     * 
     * @param values the data the model is trained with
     * @param nrClasses number of components the mixture will have
     * @param extraZero specifies if zeroes are to be treated seperately from 
     ...
     * 
     * @param model GMM to be used
     * @param extraZeroClass specifies if zeros should be treated independently
     */
    ...
    /**
     * This discretizes a value by returning the mean of that gaussian component
     * that has maximum probability for it.
     * 
