...
regle(2,<l,"ai",l>,"|ai*ei*an|","","ouvert devient fermé")		/* dans les deux sens */
regle(2,<l,"ei",l>,"|ei*ai*an|","","fermé devient ouvert")
regle(2,<l,"EI",l>,"|ei*ai*an|","","on remet les ei")
regle(2,<l,"AI",l>,"|ai*ei*an|","","on remet les ai")


regle(2,<l,"oo",l>,"|oo*au*oe*ee*ou|","","ouvert devient fermé")		/* dans les deux sens */
regle(2,<l,"au",l>,"|au*oo*oe*ee*ou|","","fermé devient ouvert")
