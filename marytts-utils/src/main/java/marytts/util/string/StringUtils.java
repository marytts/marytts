...
public class StringUtils {
    ...
    public static String[][] readTextFileInRows(String textFile, String encoding,
    ...
    public static String[][] parseFromLines(String[] lines, int minimumItemsInOneLine, int startLine,
                                            int endLine) {
        String[][] labels = null;
