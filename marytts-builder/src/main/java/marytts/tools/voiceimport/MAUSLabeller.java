...
public class MAUSLabeller extends VoiceImportComponent {
	...
	public SortedMap<String, String> getDefaultProps(DatabaseLayout db) {
		...
		if (props == null) {
			...
			props.put(TEXTGRIDDIR, db.getProp(db.ROOTDIR) + "textgrid" + System.getProperty("file.separator"));
	...
	private void ExecuteScript(String cmd, String startPath, String task) throws MaryConfigurationException,
		...
		pw.print("( cd " + startPath + "; " + cmd + "; exit )\n");
		pw.flush();
		// shut down
		pw.close();
		process.waitFor();
