...
public class Cepstrogram  extends FunctionGraph
{
    ...
    {
        this(signal, samplingRate, Window.get(DEFAULT_WINDOW, DEFAULT_FFTSIZE/4 + 1), DEFAULT_WINDOWSHIFT, DEFAULT_FFTSIZE, width, height);
    }
    ...
    {
        ShortTermCepstrumAnalyser cepstrumAnalyser = new ShortTermCepstrumAnalyser
            (new BufferedDoubleDataSource(signal), fftSize, 8192, window, windowShift, samplingRate);
