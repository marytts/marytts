...
public class JointGMMParallelTrainer extends JointGMMTrainer {
    ...
    {   
        ...
        if (!isContextualGMMs)
            gp.jointGMMFile = baseFile + "_" + String.valueOf(gp.gmmEMTrainerParams.totalComponents) + JointGMMSet.DEFAULT_EXTENSION;
        else
        {
                                      ...
                                      String sourceTag, String targetTag, String method) throws UnsupportedAudioFileException, IOException, MaryConfigurationException
    {
        ...
        pa.trainingBaseFolder = "D:/Oytun/DFKI/voices/Interspeech08_out2/" + sourceTag + "2" + targetTag; //Training base directory
    ...
    {   
        ...
        boolean isContextualGMMs = false;
        int contextClassificationType = ContextualGMMParams.NO_PHONEME_CLASS; int[] numComponents = {10};
        //int contextClassificationType = ContextualGMMParams.SILENCE_SPEECH; int[] numComponents = {16, 128};
        //int contextClassificationType = ContextualGMMParams.VOWEL_SILENCE_CONSONANT; int[] numComponents = {128, 16, 128};
        //int contextClassificationType = ContextualGMMParams.PHONOLOGY_CLASS; int[] numComponents = {numMixes};
        //int contextClassificationType = ContextualGMMParams.FRICATIVE_GLIDELIQUID_NASAL_PLOSIVE_VOWEL_OTHER; int[] numComponents = {128, 128, 128, 128, 128, 16};
     ...
     * For example the ouput in this example will be:
     *   sourceF_X_targetF_99_10.jgs --> numTrainingFiles = 99, numComponents = 10 (10 mixes)
     * Input: two directories source and target containing:
     *   /Neutral-Spike-Conversion/source/train_99/*.wav and *.lab
     *   /Neutral-Spike-Conversion/target/train_99/*.wav and *.lab
     *     In these directories it will calculate *.lsf, *.ptc, *.ene
     * Output:
