 ...
 * 
 * Reference:
 * Stephen C. Johnson, 1967, "Hierarchical clustering schemes", Proc. Psychometrika, Vol. 32 No. 3, pp. 241-254. 
 *
...
public class PolynomialHierarchicalClusteringTrainer {
     ...
     * 3. Iterate until number of clusters is equal to the given target number of clusters
    ...
    class Cluster {
        ...
        /**
         * Cluster constructor
         * @param dataSet a arraylist of samples
         * @throws NullPointerException if input dataset is null
         */
