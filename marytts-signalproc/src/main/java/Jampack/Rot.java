 ...
 * </pre>
 * 
 * The number c, which is always real, is the cosine of the rotation. The number s, which may be complex is the sine of the
 * rotation.
 * <p>
 * Comments: This suite will eventually contain methods for real rotations (two are already in place). The only difference between
 * real and complex rotations is that si and zi are zero for the former. The final routines will do the efficient thing.
 * 
 * @version Pre-alpha
 * @author G. W. Stewart
 */
...
public class Rot {
	...
	/**
	 * Given a Zmat A, genc returns a plane rotation that on premultiplication into rows ii1 and ii2 annihilates A(ii2,jj). The
	 * element A(ii2,jj) is overwriten by zero and the element A(ii1,jj) is overwritten by its transformed value.
	 * 
	 * @param A
	 *            The Zmat (altered)
	 * @param ii1
	 ...
	 * @param ii2
	 *            The row index of the second element (the one that is annihilated
	 * @param jj
	...
	/**
	 * Given a Zmat A, genc generates a plane rotation that on premultiplication into rows ii1 and ii2 annihilates A(ii2,jj). The
	 * element A(ii2,jj) is overwriten by zero and the element A(ii1,jj) is overwritten by its transformed value.
	 * 
	 * @param A
	 *            The Zmat (altered)
	...
	/**
	 * Given a Zmat A, genr returns a plane rotation that on postmultiplication into column jj1 and jj2 annihilates A(ii,jj2). The
	 * element A(ii,jj2) is overwirten by zero and the element A(ii,jj1) is overwritten by its transformed value.
	 * 
	 * @param A
	 *            The Zmat (altered)
	 * @param ii
	 ...
	 * @param jj2
	 *            The column index of the second element (the one that is annihilated)
	 * @return The rotation
	 */
	 ...
	 * The element A(ii,jj2) is overwirten by zero and the element A(ii,jj1) is overwritten by its transformed value.
	 * 
	 * @param A
	 *            The Zmat (altered)
	 * @param ii
