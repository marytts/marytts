...
public class NumberEP extends ExpansionPattern
{
    ...
    protected String expandInteger(long value)
    {
        ...
        if (rest >= 20) {
            ...
            rest = rest % 10;
            switch (rest) {
            case 1: buf.append("einund"); break;
            case 2: buf.append("zweiund"); break;
            case 3: buf.append("dreiund"); break;
            case 4: buf.append("vierund"); break;
            case 5: buf.append("fünfund"); break;
            case 6: buf.append("sechsund"); break;
            case 7: buf.append("siebenund"); break;
            case 8: buf.append("achtund"); break;
            case 9: buf.append("neunund"); break;
            default: //0: do nothing
            }
            switch (tens) {
            case 2: buf.append("zwanzig "); break;
            case 3: buf.append("dreißig "); break;
            case 4: buf.append("vierzig "); break;
            case 5: buf.append("fünfzig "); break;
            case 6: buf.append("sechzig "); break;
            case 7: buf.append("siebzig "); break;
            case 8: buf.append("achtzig "); break;
            case 9: buf.append("neunzig "); break;
            default: // shouldn't happen
            }
        } else { // rest < 20
            switch (rest) {
            case 1: buf.append("eins "); break;
            case 2: buf.append("zwei "); break;
            case 3: buf.append("drei "); break;
            case 4: buf.append("vier "); break;
            case 5: buf.append("fünf "); break;
            case 6: buf.append("sechs "); break;
            case 7: buf.append("sieben "); break;
            case 8: buf.append("acht "); break;
            case 9: buf.append("neun "); break;
            case 10: buf.append("zehn "); break;
            case 11: buf.append("elf "); break;
            case 12: buf.append("zwölf "); break;
            case 13: buf.append("dreizehn "); break;
            case 14: buf.append("vierzehn "); break;
            case 15: buf.append("fünfzehn "); break;
            case 16: buf.append("sechzehn "); break;
            case 17: buf.append("siebzehn "); break;
            case 18: buf.append("achtzehn "); break;
            case 19: buf.append("neunzehn "); break;
            default: // shouldn't happen
            }
        }
    ...
    protected String expandDigits(String digits)
    {
        ...
        for (int i=0; i<digits.length(); i++) {
            ...
            case '.': buf.append("Punkt "); break;
            case '0': buf.append("null "); break;
            case '1': buf.append("eins "); break;
            case '2': buf.append("zwei "); break;
            case '3': buf.append("drei "); break;
            case '4': buf.append("vier "); break;
   ...
   */
    ...
    protected List<Element> expandOrdinal(Document doc, long value, boolean createMtu, String orig)
    {
        ...
        switch (rest) {
        case 0:
            if (value == 0) exp.append("null");
            //else it is 100. etc.
            break;
        case 1: exp.append("ers"); break;
        case 3: exp.append("drit"); break;
        case 7: exp.append("sieb"); break;
        case 8: exp.append("ach"); break;
        default:
