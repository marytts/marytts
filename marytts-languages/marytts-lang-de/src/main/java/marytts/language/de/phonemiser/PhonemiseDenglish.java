...
public class PhonemiseDenglish {
    ...
    public PhonemiseDenglish(JPhonemiser jphon) throws Exception {
        ...
        this.prefixLexicon = mr.loadInputModel(getClass().getResourceAsStream(
                classpathPrefix + "PrefixLex.xml"));
        ...
        this.terminalVoicings = mr
                                .loadInputModel(getClass().getResourceAsStream(classpathPrefix +
                                                "terminal_voicing_for_german.xml"));
    ...
    private String processFlectionEnding(Word word, Result currentResult) {
        ...
        if (wordPlusEnding != null) {
            ...
            word = transformWordToEnBaseForm(wordMinusFlectionEnding, flectionEnding,
                                             word);// language-dependent
    ...
    private String[] separateFlectionEndings(String toBePhonemised, int endingLength) {
        ...
        if (flectionEnding != null) {
            ...
            wordMinusFlectionEnding = toBePhonemised.substring(0,
                                      toBePhonemised.length() - flectionEnding.length());
     ...
     * @return word
     */
    private Word transformWordToEnBaseForm(String wordMinusFlectionEnding, String flectionEnding,
                                           Word word) {
