...
public class WeightedCodebookParallelTrainer extends WeightedCodebookTrainer {
     ...
     * Input: 
     *   /Neutral-Spike-Conversion/codebook/neutral/train_99/*.wav and *.lab
     *   /Neutral-Spike-Conversion/codebook/angry/train_99/*.wav and *.lab
    ...
    public static void mainQuickTest2() throws UnsupportedAudioFileException, IOException
    {
        ...
        pa.trainingBaseFolder = "/project/mary/marcela/VoiceConversion/Neutral-Spike-Conversion/codebook/neutral2angry"; //Training base directory
        pa.sourceTrainingFolder = "/project/mary/marcela/VoiceConversion/Neutral-Spike-Conversion/codebook/neutral/train_99"; //Source training folder
        pa.targetTrainingFolder = "/project/mary/marcela/VoiceConversion/Neutral-Spike-Conversion/codebook/angry/train_99"; //Target training folder
