...
public class MaryHttpServerUtils {
    ...
    public static void toHttpResponse(int[] x, HttpResponse response,
                                      String contentType) throws IOException {
        toHttpResponse(ConversionUtils.toByteArray(x), response, contentType);
    }

    public static void toHttpResponse(String x, HttpResponse response,
                                      String contentType) throws IOException {
        toHttpResponse(ConversionUtils.toByteArray(x), response, contentType);
    }
    ...
    public static void fileToHttpResponse(String fullPathFile, HttpResponse response,
                                          String contentType,
    ...
    public static void errorInternalServerError(HttpResponse response, String message,
            Throwable exception) {
    ...
    public static void errorWrongQueryParameterValue(HttpResponse response, String paramName,
            String illegalValue,
            String explanation) {
        int status = HttpStatus.SC_BAD_REQUEST;
        response.setStatusCode(status);
