...
/**
 * provide comfortable access to a properties, optionally overriding settings with
 * system properties, and optionally providing string replacements.
 * @author marc
 *
 */
public class PropertiesAccessor {
	 ...
	 * @param p the properties to access
	 * @param letSystemPropertiesOverride if true, any property will first be looked up
	 * in the system properties; only if it is not found there, it will be looked up in p
	 * @param stringReplacements before->after pairs of string replacements to perform
